...
project "stark"
    ...
    files {
        ...
        "../stark3d/scene/meshrenderer.h",
        "../stark3d/scene/meshrenderer.cpp",
        "../stark3d/scene/renderer.h",
        "../stark3d/scene/renderer.cpp",
        "../stark3d/scene/material.h",
        "../stark3d/scene/material.cpp",
